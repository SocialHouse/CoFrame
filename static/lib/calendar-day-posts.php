				<div class="calendar-day">
					<div class="row bg-white clearfix post-day">
						...
						<div class="col-md-7 post-content">
							<div class="row">
								...
								<div class="col-md-10 post-meta">
									...
									<span class="post-date">Wednesday, 5/13/16 at 5:05 PM PST <a href="#" class="btn-icon btn-gray" data-edit-tag="Marketing"><i class="fa fa-pencil"></i></a></span>
									<span class="post-approval"><strong>All Approvals Received <i class="fa fa-check-circle color-success"></i></strong></span>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2 post-tags text-xs-center">
				...
				<i class="fa fa-circle color-gray-lighter" style="display: none;"></i>
								...
								<div class="col-md-10">
									...
									<button class="btn-icon btn-icon-lg btn-menu"><i class="fa fa-circle-o"></i> <i class="fa fa-circle-o"></i> <i class="fa fa-circle-o"></i></button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-7 post-content">
							<div class="row">
								...
								<div class="col-md-10 post-meta">
									...
									<span class="post-approval"><strong>Pending Approvals <i class="icon-clock2 color-danger"></i></strong></span>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2 post-tags text-xs-center">
