<div class="container-cocreate">
	...
	<ul class="timeframe-list user-list">
		<li>
			<div class="pull-sm-left"><input type="checkbox" class="hidden-xs-up" name="post-approver" value="Norel Mancuso"><i class="tf-icon check-box circle-border" data-value="Norel Mancuso" data-group="post-approver"><i class="fa fa-check"></i></i></div>
		...
		<li>
			<div class="pull-sm-left"><input type="checkbox" class="hidden-xs-up" name="post-approver" value="David Weinberg"><i class="tf-icon check-box circle-border" data-value="David Weinberg" data-group="post-approver"><i class="fa fa-check"></i></i></div>
		...
		<li>
			<div class="pull-sm-left"><input type="checkbox" class="hidden-xs-up" name="post-approver" value="Kristin Patrick"><i class="tf-icon check-box circle-border" data-value="Kristin Patrick" data-group="post-approver"><i class="fa fa-check"></i></i></div>
		...
		<li>
			<div class="pull-sm-left"><input type="checkbox" class="hidden-xs-up" name="post-approver" value="Johan Loekito"><i class="tf-icon check-box circle-border" data-value="Johan Loekito" data-group="post-approver"><i class="fa fa-check"></i></i></div>
		...
		<li>
			<div class="pull-sm-left"><input type="checkbox" class="hidden-xs-up" name="post-approver" value="Jose Andrade"><i class="tf-icon check-box circle-border" data-value="Jose Andrade" data-group="post-approver"><i class="fa fa-check"></i></i></div>
		...
		<li>
			<div class="pull-sm-left"><input type="checkbox" class="hidden-xs-up" name="post-approver" value="Sophie Hawkins"><i class="tf-icon check-box circle-border" data-value="Sophie Hawkins" data-group="post-approver"><i class="fa fa-check"></i></i></div>
