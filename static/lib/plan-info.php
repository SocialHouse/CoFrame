<div class="btn-group"> <a href="user-preferences.php" class="btn btn-sm">My Info</a> <a href="user-plan.php" class="btn btn-sm active">Plan</a> <a href="user-billing.php" class="btn btn-sm">Billing</a> </div>
