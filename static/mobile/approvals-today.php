...
<body class="page-global">
							...
							<div class="post-footer clearfix">
								<span class="pull-xs-left post-actions">
									<div class="before-approve">
										<a class="btn btn-xs btn-secondary change-approve-status" data-post-id="28" data-phase-id="" data-phase-status="approved">Approve</a>
									</div>
									<div class="after-approve hidden">
										<button class="btn btn-secondary btn-disabled btn-sm" disabled="">Approved</button>
									</div>
								</span>
								<div class="hide-top-bx-shadow pull-xs-right">
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content bg-white">
		  ...
		  <div class="modal-body">
			<div id="calendar-select-date" class="calendar-select-date">
	...
	<script src="https://timeframe-dev.blueshoon.com/assets/js/vendor/moment.min.js?ver=2.11.0"></script>
	<script src="https://timeframe-dev.blueshoon.com/assets/js/vendor/fullcalendar.min.js?ver=2.6.1"></script>
