<?php
	...
	$lang['plan_change_success'] = "You have successfully changed your plan.";
	$lang['unable_to_change_plan'] = "We were unable to change your plan - please try again.";
	$lang['payment_processing_error'] = "There was a problem processing your payment - please try again.";
	$lang['subscription_thank_you'] = "Thank you for subscribing to CoFrame!";
	$lang['payment_processing'] = "There was a problem processing your payment - please try again.";
...
<<<<<<< HEAD
	...
	$lang['re_enter_pass'] = "Please confirm your password.";
	...
	$lang['mini_char'] = "Password must be at least six characters.";
...
>>>>>>> b96cc0bf199b0b5f4e60c80b889fcfe0561d108e
	...
	$lang['edit_req_not_save'] = "We were unable to save - please try again.";
	$lang['edit_req_save'] = "Your suggested edit has been saved.";
	$lang['unable_to_change_status'] = "Unable to change status";
	$lang['unable_to_save_reply'] = "We were unable to save your reply - please try again.";
	$lang['unable_to_post'] = "We were unable to schedule this post - please try again.";
	...
	$lang['change_plan_confirmation'] = "Are you sure you want to change your plan?";
	$lang['change_plan_billing_details'] = "To change your plan, please first add your payment information.";
	$lang['delete_phase_confirmation'] = "Are you sure you want to delete this phase?";
	$lang['image_size_limit'] = "Image size must be less than %size%.";
	$lang['invalid_extention'] = "This is an invalid file extension. Please upload a PNG, JPG, or GIF.";
	$lang['browser_not_supported'] = "Please update your browser to use this feature.";
	$lang['upload_error'] = "There was a problem with your upload - please try again.";
	$lang['video_size_limit'] = "Video size must be less than %size%.";
	$lang['video_upload_error'] = "You cannot upload more than 1 video.";
	$lang['enter_valid_datetime_slate_greater_than_date_than_approval'] = "The Slate date must be later than your Approve By dates.";
	$lang['enter_valid_datetime_approval_than_date_than_slate_date'] = "The Approve By date must be earlier than the Slate date.";
	$lang['enter_hour_minutes'] ="Please enter hour and minutes.";
	$lang['valid_hour_minutes'] ="Please enter valid time.";
...
>>>>>>> b96cc0bf199b0b5f4e60c80b889fcfe0561d108e
	...
	$lang['vine_outlet_change_error'] = "Vine does not allow images - please delete before switching to Vine.";
	$lang['youtube_outlet_change_error'] = "Youtube does not allow images - please delete before switching to Youtube.";
	$lang['insta_outlet_change_error'] = "Instagram does not allow GIFs - please delete before switching to Instagram.";

	$lang['insta_outlet_change_img_error'] = "Only 1 image is allowed for Instagram - please delete extra images before switching to Instagram.";

	$lang['linkedin_outlet_change_error'] = "Only 1 image is allowed for LinkedIn - please delete extra images before switching to LinkedIn.";
...
>>>>>>> b96cc0bf199b0b5f4e60c80b889fcfe0561d108e
	...
	//access denied page
	$lang['access_denied_approval_page'] = "You do not have permission to access Approvals. Please contact your Master Admin for access.";

	// confirm delete phase
	$lang['confirm_delete_phase'] = "Are you sure you want to delete this phase? You cannot undo this action.";

	// confirm cancel message
	$lang['confirm_cancel'] = "Are you sure you want to cancel?";

	//plan access errors
	$lang['outlet_limit'] = 'Your plan only supports %outlet_number% outlets per brand.';
	$lang['tag_limit'] = 'You have reached your tag limit - either delete a tag or upgrade your plan.';
	$lang['user_limit'] = 'Your plan only supports %outlet_number% outlets per brand.';
	$lang['master_user_limit'] = 'Your plan only supports %master_user_number% Master Admins.';

	$lang['user_limit_downgrade'] = 'Please remove %user_number% users before changing your plan.';
	...
	$lang['present_in_current_ac_preference'] = 'This user is already an active user on this brand. You cannot add this person on this account.';

	$lang['master_admin_email'] = 'This user is the Master Admin and already has access to this brand.';
	...
	$lang['unable_to_schedule'] = "We were unable to schedule post - please try again.";
	$lang['schedule_post_modal_msg'] = "You have not received all approvals - would you like to send the pending approvers an email or schedule as is?";

	$lang['save_successfully'] = "Your %type% information saved successfully.";
	$lang['already_saved'] = "Your %type% information has already been saved.";

	$lang['finish_Phase'] = "You have not received all approvals. Are you sure you still want to finish this Phase?";

	$lang['biling_downgrade'] = "You cannot downgrade your plan right now. Please contact billing@coframeapp.com.";

	$lang['enter_url'] = "Please enter a URL.";

	// tumblr validation errors
	$lang['enter_url_embed_data_image'] = "Please enter either a URL, embed code or upload an image.";
	$lang['enter_url_embed_data_video'] = "Please enter either a URL, embed code or upload a video.";
	$lang['enter_audio_url'] = "Please enter audio URL or upload audio from your computer.";
	$lang['enter_chat_copy'] = "Please enter chat copy.";
	$lang['enter_link'] = "Please enter link.";
	$lang['enter_quote'] = "Please enter quote.";
	$lang['enter_body'] = "Please enter post copy.";
	
	// youtube validation errors
	$lang['youtube_title_error'] = "Please enter a video title.";
	$lang['youtube_video_error'] = "Please upload a video.";

	// pinteres validation errors	
	$lang['pinterest_bord_error'] = "Please select a board.";
	$lang['pinterest_upload_error'] = "Please upload an image.";


	// tumblr Change Content Type message
	$lang['tumblr_change_img_error'] = "Please delete images before switching to %Content_type%.";
	$lang['tumblr_change_video_error'] = "Please delete videos before switching to %Content_type%.";
	$lang['tumblr_change_audio_error'] = "Please delete audio before switching to %Content_type%.";
