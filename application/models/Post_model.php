...
class Post_model extends CI_Model
{
	...
	public function get_post($post_id)
	{
		...
		$this->db->select('posts.id,posts.content,posts.outlet_id, posts.brand_id, posts.slate_date_time, posts.created_at, CONCAT (CONCAT(UCASE(LEFT(user.first_name,1)), 
                             ...
                             SUBSTRING(user.last_name, 2))) as user ,user.aauth_user_id as user_id,brands.created_by,LOWER(outlets.outlet_constant) as outlet_name,posts.status,brands.slug');
