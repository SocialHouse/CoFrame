<form id="step_1_edit" class="has-advanced-upload" method="POST" action="<?php echo base_url()?>/brands/save_brand" enctype="multipart/form-data">
			...
			?> 
				<div class="brand-logo">
					...
					<div class="form__input center-block brand-image  <?php echo $cls_2; ?>">
						<?php echo $image; ?>
						<input type="file" name="files[]" id="brandFile" class="form__file" data-multiple-caption="{count} files selected">
