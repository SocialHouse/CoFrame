...
<form action="<?php echo base_url().'payment/save_payment' ?>" method="POST" id="payment-form">
  	<div class="row">  		
		<div class="form-group col-md-12">
		    ...
		    <input type="text" placeholder="cc number" data-stripe="number" class="form-control" name="cc_number" id="cc_number" value="<?php echo !empty(set_value('cc_number'))? set_value('cc_number'):''; ?>" required>
	  	</div>
	  	<div class="form-group col-md-12">
	            ...
	            <select class="form-control" name="expiry_month" data-stripe="exp-month" id="expiry_month" required>
	                ...
	                {	                	
	                	...
	                	$month = $i;                	
	                  	...
	                  	?>
	                  	<option <?php echo set_select("expiry_month", $month); ?> value="<?php echo $month ?>"><?php echo $month ?></option>'
	                  	<?php
	                }
	                ?>
	            </select>
	            ...
	            <select class="form-control" name="expiry_year" data-stripe="exp-year" id="expiry_year" required>
	                ...
	                for($i=0; $i<12; $i++)
	                {
		                $year = date('Y', strtotime('+'.$i.' years'));
		               	...
		               	?>		               	
		               	<option <?php echo set_select("expiry_year", $year); ?> value="<?php echo $year ?>"><?php echo $year ?></option>
		                <?php
	                }
	                ?>
	            </select>
	    ...
	    <div class="form-group col-md-12">
	        ...
	        <input type="text" placeholder="cvc" class="form-control" name="cvc" id="cvc" data-stripe="cvc"  value="<?php echo set_value('cvc'); ?>" required>
	  	</div>
	    <div class="form-group col-md-12">
