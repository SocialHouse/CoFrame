...
<div id="addUserRole" class="hidden">
	<h5 class="text-xs-center border-bottom border-black ">Set Role</h5>
	<div class="permissions-current-user text-xs-center">
		<img src="<?php echo img_url(); ?>default_profile.jpg" width="36" height="36" alt="user image" class="circle-img user-img-preview"/>
		<div class="form-uploading user-upload-img hide">Uploading...</div>
...
<!-- 	<div id="adminPermissions" class="permission-details hidden">
	...
	<div id="managerPermissions" class="permission-details hidden">
		...
		<ul class="timeframe-list permissions-list view">
			...
			<li>Brand Settings <input type="checkbox" class="hidden-xs-up" name="manager-permissions[]" value="settings" checked><i class="tf-icon check-box circle-border pull-sm-right selected" data-value="settings" data-group="manager-permissions[]"><i class="fa fa-check"></i></i></li>
