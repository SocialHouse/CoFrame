			...
			<section id="user-preferences" class="page-main bg-white col-sm-12">
				...
				<div class="row">
					<div class="col-md-4 col-md-offset-4 text-xs-center">
						<div class="user-info">
							<div class="btn-group">
								<a href="<?php echo base_url(); ?>user_preferences" class="btn btn-sm active">My Info</a>
								<a href="<?php echo base_url(); ?>user_preferences/user_plan" href="user-plan.php" class="btn btn-sm">Plan</a>
								<a href="<?php echo base_url(); ?>user_preferences/user_billing" href="user-billing.php" class="btn btn-sm">Billing</a>
							</div>
							<form action="" id="user_info" novalidate>
								<img src="assets/images/fpo/norel.jpg" alt="Norel Mancuso" class="circle-img user-img">
