												...
												<form id="user_preferences_add_user" method="POST" class="file-upload clearfix has-advanced-upload " action="<?php echo base_url()?>user_preferences/add_user" enctype="multipart/form-data">
													...
													<div class="form-group">
														...
														<select class="form-control" id="userRoleSelect" name="role">
															...
															if(!empty($groups))
															{
																...
																{
																	if (($group->name == 'Admin' && $master_user_count < $this->plan_data['master_admins'] )|| $group->name == 'Billing'  )
																	{
																		?>
													...
													<footer class="post-content-footer">
														...
														<div id="updateUserBtns">
															<button type="button" class="btn btn-sm btn-default pull-sm-left show-hide btn-cancel" data-hide="#addNewUser,#addUserLink" data-show="#addUserLink, #users_list">Cancel</button>
															<button type="submit"" class="btn btn-sm pull-sm-right btn-secondary update_user" >Update</button>
														</div>
													</footer>
												</form>
											</div>
