...
class Approvals extends CI_Controller {
	...
	function index()
	{
		...
		if(!empty($brand))
		{
			...
			$this->data['js_files'] = array(js_url().'vendor/isotope.pkgd.min.js?ver=3.0.0',js_url().'vendor/moment.min.js?ver=2.11.0',js_url().'vendor/fullcalendar.min.js?ver=2.6.1',js_url().'vendor/jquery.dotdotdot.min.js?ver=1.8.1',js_url().'calendar-config.js?ver=1.0.0', js_url().'drag-drop-file-upload.js?ver=1.0.0',js_url().'post-filters.js?ver=1.0.0',js_url().'view-n-edit-request.js?ver=1.0.0');
