jQuery(document).ready(function($){
  ...
  calcPercent();
    ...
    function dynamic_items(){
        ...
        //column
         if( $('.shortcode-options[data-name=sp_columns]').is(':visible') ){
            $('.shortcode-options[data-name=sp_columns] .shortcode-dynamic-item-size').each(function(){
              // if( $(this).val() != '' ) {
                    ...
                    code += '[sp_column size="'+tabColumn+'" id="column'+columnID+'"]'+tabContent+'[/sp_column]'; 
                    columnID++;
                //}
            });
         }
                ...
                //social
         else if( $('.shortcode-options[data-name=sp_social]').is(':visible') ){
            $('.shortcode-options[data-name=sp_social] .shortcode-dynamic-item-url').each(function(){
              // if( $(this).val() != '' ) {
                    ...
                    code += '[sp_media name="'+socialMedia+'" url="'+socialURL+'"]'; 
                    socialID++;
                //}
            });
         }
                ...
                // progress
         else if( $('.shortcode-options[data-name=sp_progressbar]').is(':visible') ){
            $('.shortcode-options[data-name=sp_progressbar] .shortcode-dynamic-item-style').each(function(){
              // if( $(this).val() != '' ) {
                    ...
                    code += '[sp_bar style="'+progressStyle+'" width="'+progressWidth+'" min="'+progressMin+'" max="'+progressMax+'" default="'+progressDefault+'"] '+ progressText +' [/sp_bar]'; 
                    progressID++;
                //}
            });
         }
    ...
    function update_shortcode(ending){
        ...
        if(name == 'sp_icon' && $('.icon-option i.selected').length > 0 ) {
			var selected = $('.icon-option i.selected').attr('class');
			var imgclass = selected.replace(' selected', '');
			code += ' image="'+ imgclass +'"'; 
		}
        code += ']';
