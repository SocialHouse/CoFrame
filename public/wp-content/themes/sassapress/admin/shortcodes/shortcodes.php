...
<div id="shortcode-generator">
    ...
    <div class="shortcode-content">     
        ...
        <div class="content"><select id="sp-shortcodes" data-placeholder="' . __("Choose a shortcode", SPTEXTDOMAIN) .'">
            ...
            if(strpos($shortcode,'header') !== false) {
                ...
                if( !empty($options['attr']) ){
                     foreach( $options['attr'] as $name => $attr_option ){
                        $html_options .= sp_option_element( $name, $attr_option, $options['type'], $shortcode );
                     }
                }
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/admin/css/font-awesome.min.css" />
...
<?php echo $shortcode_html . $html_options;  ?>
    ...
    <div id="shortcode-content">
        ...
        <div class="label"><label id="option-label" for="shortcode-content"><strong><?php echo __( 'Content: ', SPTEXTDOMAIN ); ?></strong> </label></div>
    ...
    <a class="btn" id="add-shortcode"><?php echo __( 'Add Shortcode', SPTEXTDOMAIN ); ?></a>
