...
function sp_option_element( $name, $attr_option, $type, $shortcode ){
    ...
    switch( $attr_option['type'] ){
        ...
        if( $name == 'progressbar' ){
            ...
            <a href="#" class="btn yellow remove-list-item">'.__('Remove', SPTEXTDOMAIN ). '</a> 
            <a href="#" class="btn yellow add-list-item">'.__('Add', SPTEXTDOMAIN ).'</a>';
        ...
        elseif( $name == 'column' ){
            ...
            <a href="#" class="btn yellow remove-list-item">'.__('Remove Column', SPTEXTDOMAIN ). '</a> <a href="#" class="btn yellow add-list-item">'.__('Add Column', SPTEXTDOMAIN ).'</a>';
        ...
        elseif( $name == 'image' ){
            ...
            <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary" rel-id="">' . __('Upload', SPTEXTDOMAIN) . '</a>
            <a href="javascript:void(0);" class="redux-opts-upload-remove" style="display: none;">' . __('Remove Upload', SPTEXTDOMAIN) . '</a>';
