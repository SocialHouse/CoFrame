...
//print_r($default_settings['google_fonts']); die;
                    ...
                    /* Font Weight */
                    if( isset($default_settings['weight']) and isset($typography_stored['weight'])) {
                        ...
                        $weights = array("" => "Inherit","100" => "Thin","300" => "Light","400" => "Normal","500" => "Medium","600" => "Semi-Bold","700" => "Bold","800" => "Extra-Bold","800" => "Ultra-Bold");
