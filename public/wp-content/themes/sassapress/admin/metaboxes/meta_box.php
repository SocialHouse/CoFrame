		...
		// term_select
			...
			echo '<select name="' . esc_attr( $name ) . '" id="' . esc_attr( $id ) . '">
					...
					foreach ( $terms as $term ) {
						...
						echo '<option value="' . $term_value . '" name="term_input[' . $id . '][]" id="' . $id . '-' . $term_value . '"' . selected( $selected, $term_value, false ) . '>' . $term->name . '</option>'; 
					}
					echo '</select>
					<br />';
					break;
		// tax_select
			...
			echo '<select name="' . esc_attr( $name ) . '" id="' . esc_attr( $id ) . '">
					...
					foreach ( $terms as $term ) {
						...
						echo '<option value="' . $term_value . '" name="tax_input[' . $id . '][]" id="' . $id . '-' . $term_value . '"' . selected( $selected, $term_value, false ) . '>' . $term->name . '</option>'; 
					}
...
class Custom_Add_Meta_Box {
	...
	function admin_enqueue_scripts() {
		...
		wp_register_style( 'fontawesome', CUSTOM_ADMIN_DIR . '/css/font-awesome.min.css' );
...
echo '});
	...
	function save_box( $post_id ) {
		...
		foreach ( $this->fields as $field ) {
			...
			//allow html markup if using wp_editor
