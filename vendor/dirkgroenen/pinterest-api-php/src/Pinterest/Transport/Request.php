...
class Request {
    ...
    public function create_bord($endpoint, array $parameters = array())
    {
        $curl = curl_init();

        $parameters['access_token']= 'AXAq9P9cswx5zN_lFMNWADqL2vKLFGfS2XJyMMlC7jcufCArZgAAAAA';
        $url_string = http_build_query($parameters);

        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://api.pinterest.com/v1/boards/",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
